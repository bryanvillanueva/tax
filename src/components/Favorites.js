...
const forms = [
            { code: '1', id: 'depreciation', title: 'Depreciation Form', description: 'Calculate accelerated depreciation (Section 179).' },
            ...
            { code: '2', id: 'savingsPlan', title: '529 Savings Plan Form', description: 'Calculate projected savings for future goals, accounting for annual contributions, interest rates, and time periods.' },
            ...
            { code: '4', id: 'selfDirectedIRA401K', title: 'Self-Directed IRA & 401K Form', description: 'Evaluate self-directed IRA and 401K plans, including investment options, tax benefits, and compliance considerations.' },
            { code: '4', id: 'dayTraderTaxStatus', title: 'Day Trader Tax Status Form', description: 'Analyze tax implications for day traders, including qualification criteria, deductions, and mark-to-market election strategies.' },
            { code: '4', id: 'collegeStudentStrategies', title: 'College Student Strategies Form', description: 'Explore tax planning strategies for college students, including education credits, tax-free savings, and financial aid impacts.' },
            { code: '4', id: 'sellHomeToSCorp', title: 'Sell Home to S-Corp Form', description: 'Assess the tax and financial implications of selling a personal residence to an S-Corporation, including capital gains treatment and business use considerations.' },
            { code: '4', id: 'giftingStockStrategy', title: 'Gifting Stock Strategy Form', description: 'Review tax-efficient strategies for gifting stocks, including cost basis considerations, donor benefits, and charitable giving options.' },
            { code: '4', id: 'realEstateOptions', title: 'Real Estate Options Form', description: 'Examine real estate investment options, including lease options, seller financing, and tax-deferred exchanges.' },
            { code: '4', id: 'marriedFilingSeparate', title: 'Married Filing Separate Form', description: 'Compare the tax implications of filing separately versus jointly for married couples, including deductions, credits, and financial planning strategies.' },
            { code: '4', id: 'individualPlanningIdeas', title: 'Individual Planning Ideas Form', description: 'Discover personalized tax and financial planning strategies tailored to individual needs, risk tolerance, and long-term goals.' },
            { code: '4', id: 'netInvestmentIncomeTax', title: 'Net Investment Income Tax Form', description: 'Analyze the Net Investment Income Tax (NIIT), including thresholds, affected income types, and mitigation strategies.' },
            { code: '4', id: 'miscTaxCredits', title: 'Miscellaneous Tax Credits Form', description: 'Review various tax credits available to individuals and businesses, including eligibility requirements and optimization techniques.' },
            { code: '4', id: 'rentalStrategies754Election', title: 'Rental Strategies & 754 Election Form', description: 'Explore rental property tax strategies and the Section 754 election for partnerships, including depreciation adjustments and basis step-ups.' },
